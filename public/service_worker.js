/*
 ...
 service_worker.js
 Employs a service worker to cache pages for the Neighborhood Map App
 Created from build file but then redeployed for use in production environment
 Author: Steve Prager
...
var precacheConfig = [
        ["/index.html",
            "f68fa23816742562878503264ba16eb1"
        ],
        ["/static/css/main.d425b69e.css",
            "a32559063a144b54b21831c857c41b99"
        ],
        ["/static/js/main.57646441.js",
            "bb571f47e92da0170b34bc65c187c88b"
        ]
    ],
